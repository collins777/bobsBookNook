...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // Page 5 // Project 4
        checkTables(txtOwnerID.Text + "HISTORY", "CREATE TABLE " + txtOwnerID.Text + "HISTORY (EMAIL CHART(64), ISBN CHAR(14))");
        initLstProgress(); 
    ...
    private void checkTables(string Table, string sqlStatement)
    {
        ...
        // check for error message: creat the connection if necessary 
    ...
    protected void btnClearDB_Click(object sender, EventArgs e)
    {
        ...
        // use the drop down command to clear the database 
    ...
    protected void btnLoadImages_Click(object sender, EventArgs e)
    {
        ...
        if (!FileUpload1.HasFiles)
        {
            ...
            lstProgress.Items.Add("all image from the directory");
            FileUpload1.Focus(); 
        } 
        else
        {
        ...
        foreach (HttpPostedFile uploadedFile in FileUpload1.PostedFiles)
            {
                ...
                //Response.Write(newFileName + "<hr>"); // FOR TESTING ONLY 
    ...
    private void decode(ListBox lstHidden)
    {
        ...
        // remove the first two line from lstHidden 
        // we do not need the <?xml version="1.0 encoding="utf-8"?>
        // nor do we need to process < Inventory > 
        lstHidden.Items.RemoveAt(0);
        lstHidden.Items.RemoveAt(0);

        // Create the start record of a SQL statement 
        while (lstHidden.Items.Count > 1)
        {
            string sqlStatement = "INSERT INTO " + txtOwnerID.Text +
                "BOOKS (Title, ISBN, Author, Category, Image, Description) VALUES (";
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                {
                    // if description is over 255 character, it needs to be truncated
                    // to fit our field descriptors
                    ...
                    // Replace all ' with '': single with doubl e
                    field = field.Replace("'", "''");
                    // append to sqlStatment
                    sqlStatement += " '" + field + "'"; 
                }
            ...
            // remove </books> tag
            // Make sure this is whitin the while code block. 
            lstHidden.Items.RemoveAt(0);  
        }
    }
    ...
    protected void toBookStore_Click(object sender, EventArgs e)
    {
    ...
    // Page 15 // Project 3
    protected void btnRemoveBookTitle_Click(object sender, EventArgs e)
    {
        Response.Redirect("removeBooksFromInventory.aspx");
    }

    // Page 6 // Project 5
    protected void btnEmailMarketing_Click(object sender, EventArgs e)
    {
